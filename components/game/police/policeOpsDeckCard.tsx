import { PoliceOpsCard, PoliceOpsMovimentTypes } from '../../../utils/constants';
...
const PoliceOpsDeckCard: React.FC<{ policeOpsCard: PoliceOpsCard }> = ({ policeOpsCard }) => {
  ...
  return (
        <div className="w-[160px] h-[240px] p-2 rounded-md flex flex-col justify-top bg-white text-center shadow-md">
